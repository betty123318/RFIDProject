...
namespace Xuite_Player {
    ...
    public sealed partial class MainPage : Page {
        ...
        public MainPage() {
            ...
            OUTPUT.IsItemClickEnabled = true;
        }
        ...
        private void NotSelectAllButton_Click(object sender, RoutedEventArgs e) {
            OUTPUT.SelectedIndex = -1;
        }

        private void OUTPUT_LayoutUpdated(object sender, object e) {
        }

        private void OUTPUT_ItemClick(object sender, ItemClickEventArgs e) {
            ItemData temp = (ItemData)e.ClickedItem;
            this.Frame.Navigate(typeof(PlayerPage),new string[]{temp.title,temp.vlog_id,temp.thumb});

            int selectindex = ((GridView)sender).Items.IndexOf(e.ClickedItem);
            Debug.WriteLine("目前點選的是:" + selectindex);
            //UIElement temp = (UIElement)e.ClickedItem;
